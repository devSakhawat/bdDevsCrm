(function () {
    ...
    window.ApplicationModule.config = {
        ...
        apiEndpoints: {
            ...
            scholarshipsByApplication: function (id) { return `${apiRoot}/crm-scholarship-applications-by-application/${id}`; },
            createScholarship: `${apiRoot}/crm-scholarship-application`,
            deleteScholarship: function (id) { return `${apiRoot}/crm-scholarship-application/${id}`; },
            scholarshipImpact: function (id) { return `${apiRoot}/crm-scholarship-commission-impact/${id}`; },
            visasByApplication: function (id) { return `${apiRoot}/crm-visa-applications-by-application/${id}`; },
            createVisa: `${apiRoot}/crm-visa-application`,
            changeVisaStatus: `${apiRoot}/crm-visa-application-status-transition`,
            visaStatusHistoryByVisaApplication: function (id) { return `${apiRoot}/crm-visa-status-histories-by-visa-application/${id}`; },
            checklistsByStudent: function (id) { return `${apiRoot}/crm-student-document-checklists-by-student/${id}`; },
            paymentsByApplication: function (id) { return `${apiRoot}/crm-student-payments-by-application/${id}`; },
            createPayment: `${apiRoot}/crm-student-payment`,
            changePaymentStatus: `${apiRoot}/crm-student-payment-status-transition`,
            paymentReceipt: function (id) { return `${apiRoot}/crm-student-payment-receipt/${id}`; },
            refundsByPayment: function (id) { return `${apiRoot}/crm-payment-refunds-by-payment/${id}`; },
            createRefund: `${apiRoot}/crm-payment-refund`,

...
public class CrmApplicationController : BaseApiController
{
    ...
    public async Task<IActionResult> ApplicationSummaryAsync([FromBody] GridOptions options, CancellationToken cancellationToken = default)
    {
        ...
        var summaryGrid = await _serviceManager.CrmApplications.ApplicationsSummaryAsync(options, cancellationToken);
    ...
    public async Task<IActionResult> DeleteApplicationAsync([FromRoute] int key, CancellationToken cancellationToken = default)
    {
        ...
        await _serviceManager.CrmApplications.DeleteApplicationAsync(key, trackChanges: false, cancellationToken: cancellationToken);
    ...
    public async Task<IActionResult> ApplicationsAsync(CancellationToken cancellationToken = default)
    {
        ...
        if (!applications.Any())
            return Ok(ApiResponseHelper.Success(Enumerable.Empty<CrmApplicationDto>(), "No applications found."));

        return Ok(ApiResponseHelper.Success(applications, "Applications retrieved successfully"));
    }

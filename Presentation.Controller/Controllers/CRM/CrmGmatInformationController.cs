...
/// <summary>
/// CrmGmatInformation management endpoints.
/// </summary>
[AuthorizeUser]
public class CrmGmatInformationController : BaseApiController
{
    private readonly IMemoryCache _cache;

    public CrmGmatInformationController(IServiceManager serviceManager, IMemoryCache cache) : base(serviceManager)
    {
        _cache = cache;
    }
    ...
    /// </summary>
    [HttpPost(RouteConstants.CrmGmatInformationSummary)]
    ...
    /// </summary>
    [HttpPost(RouteConstants.CreateCrmGmatInformation)]
    ...
    /// </summary>
    [HttpPut(RouteConstants.UpdateCrmGmatInformation)]
    [ServiceFilter(typeof(EmptyObjectFilterAttribute))]
    ...
    /// </summary>
    [HttpDelete(RouteConstants.DeleteCrmGmatInformation)]
    ...
    /// </summary>
    [HttpGet(RouteConstants.ReadCrmGmatInformation)]
